    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <a onclick="createSpecialization()" class="btn btn-success" role="button"><i class="material-icons">add</i>&nbsp;Add Specialization</a>
                        ...
                        <table id="myEmployeeTable" class="table table-bordered table-striped advanced_table fs-12">
                            ...
                            <c:forEach var="specialization" items="${specializations}">
                                <tr>
                                    ...
                                    <td>${specialization.createdDate}</td>
...
<script type="text/javascript">
    ...
    function deleteSpecialization(id) {
        ...
        if (msg) {
            ...
            var url = baseUrl + 'specialization/delete';
            $.post(url, {id: id})
...
<%@include file="modal-add-specialization.jsp" %>
