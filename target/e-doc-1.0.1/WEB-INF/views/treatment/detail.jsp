<%@include file="../fragments/header.jsp"%>
	<div class="content-wrapper">
	    <section class="content-header">
	        <h1> Treatment Management <span> <i class="fa fa-angle-double-right"></i>
	    	...
	    	<div class="box">   
            	...
            	<div class="box-body">
        			<ul class="nav nav-tabs" id="machineTabs">
						<li><a data-toggle="tab" href="accidentDetail"><i class="material-icons">account_balance</i>&nbsp;Treatment Detail</a> </li>
					</ul>
						  			...
						  			<div class="single-info">
								  		<h3> Basic Details</h3>
								  			<div class="info-item">
												...
												<span class="inp"><a href="${baseUrl}/patient/${treatmentDetails.PId}/details">${treatmentDetails.patientName}</a></span>
									  		</div>
										<div class="info-item">
											<label class="lab"> Doctor Name  </label>
											<span class="inp"><a href="${baseUrl}/doctor/${treatmentDetails.doctorId}/details"> ${treatmentDetails.DName}</a></span>
										</div>

										  	<div class="info-item">
										  		<label class="lab"> Prescription Date </label>
										  		<span class="inp"> ${treatmentDetails.dateOfPrescription}</span>
										  	</div>
										  	<div class="info-item">
										  		<label class="lab"> Prescription FeedBack </label>
										  		<span class="inp"> ${treatmentDetails.prescriptionFeedback}</span>
										  	</div>
								  	</div>  
						  		</div>
						  		<div class="col-md-6">
						  			...
						  			<c:forEach var="image" items="${fn:split(treatmentDetails.prescriptionPhoto, ',')}">
