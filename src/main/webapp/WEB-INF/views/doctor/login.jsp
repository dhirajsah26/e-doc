...
<body class="hold-transition login-page">
  <div id="particles-js"></div>
    ...
    <div class="row">
      <div class="col-md-6 login-left">   
          <div class="login-content text-center">
           ...
           <%-- <a href="https://edigitalnepal.com"><img src="${baseUrl}/resources/dist/img/" class="img-responsive edn-logo" width="150" height="150" alt="edigital logo"></a>--%>
              ...
              <a href="${baseUrl}/doctor/signup" class="btn btn-blue btn-block btn-login">SIGN UP</a>
      ...
      <div class="col-md-6">
        <form id="login-form" class="login-content" action="${baseUrl}/doctor/login" method="post" autocomplete="off">
