...
<c:set var="baseUrl" value="${pageContext.request.contextPath}" scope="application" />
  ...
  <title>School-College Sign Up | School Management System</title>
...
<h3 class="text-center">Sign up</h3>
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Create New Admin Account</p>

    <form action="${baseUrl}/admin/signup" method="post">
    	${message}
