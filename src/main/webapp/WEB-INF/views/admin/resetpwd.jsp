    ...
    <section class="content">
    	<div class="row">
    		<div class="col-md-6">
    			<div class="box">
			        <div class="box-body">
			        	<form action="${baseUrl}/admin/${admin.username}/resetpwd" method="post" id="change_pwd_form">
					    	${message}
					    	  <p>You are here to reset password of <a target="_blank" href="${baseUrl}/admin/${admin.username}">${admin.name}</a>.</p>
					    	  <hr>
						      ...
						      <a href="${baseUrl}/admin/all" class="btn btn-default"><i class="fa fa-arrow-left"></i></a>
					    </form>
			        </div>
			    </div>
			   </div>
